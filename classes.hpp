...
public:
    ...
    // void send_rsp_out(coh_msg_t coh_msg, line_addr_t addr, line_t line, cache_id_t req_id, cache_id_t dest_id, invack_cnt_t invack_cnt, word_offset_t word_offset, word_mask_t word_mask);
    ...
    // void send_dma_rsp_out(coh_msg_t coh_msg, line_addr_t addr, line_t line, llc_coh_dev_id_t req_id, cache_id_t dest_id, invack_cnt_t invack_cnt, word_offset_t word_offset);
...
public:
    ...
    void llc_lookup_in_mem(LLC_DATA_ADDR *addr, bool &evict);
};
